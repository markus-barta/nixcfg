...
in
{
  ...
  # Link macOS GUI Applications. List currently empty after the WezTerm purge
  # (2026-05-05 — Ghostty replaces WezTerm; Ghostty installed via Homebrew, not
  # Nix). One-shot cleanup also removes the lingering pre-purge alias.
