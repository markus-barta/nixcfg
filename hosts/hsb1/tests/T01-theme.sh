...
print_header "T01 - Theme Module Tests (hsb1 / green)"
...
check_file_contains "$STARSHIP_CONFIG" "hsb1" "Starship config mentions hostname 'hsb1'"
check_file_contains "$STARSHIP_CONFIG" "Green" "Starship config mentions 'Green' theme"
check_file_contains "$STARSHIP_CONFIG" "theme-hm.nix" "Starship config auto-generated by theme-hm.nix"
check_file_contains "$STARSHIP_CONFIG" "green" "Starship config uses green palette"
...
# ────────────────────────────────────────────────────────────────────────────────
# T01.3 - Starship Green Palette Colors
# ────────────────────────────────────────────────────────────────────────────────

print_test "T01.3 - Starship Colors (green palette)"

# These are the green gradient colors from theme-palettes.nix
check_file_contains "$STARSHIP_CONFIG" "#e8ffe0" "Lightest gradient color (green) present"
check_file_contains "$STARSHIP_CONFIG" "#70d860" "Primary gradient color (green) present"
check_file_contains "$STARSHIP_CONFIG" "#40b030" "Secondary gradient color (green) present"
...
check_file_contains "$ZELLIJ_CONFIG" "hsb1" "Zellij config mentions hostname 'hsb1'"
check_file_contains "$ZELLIJ_CONFIG" "Green" "Zellij config mentions 'Green' theme"
...
check_file_contains "$ZELLIJ_CONFIG" 'theme "hsb1"' "Zellij uses hostname as theme name"
check_file_contains "$ZELLIJ_CONFIG" "hsb1 {" "Zellij theme block defined for hsb1"
