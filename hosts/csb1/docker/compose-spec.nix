...
in
{
  ...
  services = {
    ...
    inspr-auth = {
      ...
      # the 2026-05-11 rescue build ghcr.io/inspr-at/inspr-auth:legacy-20260511
      # @sha256:090c82cf…, which stays on GHCR as the rollback target.
