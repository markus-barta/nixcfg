...
# at runtime via agenix-decrypted bind. No plaintext secrets in this file.
{
  ...
  services = {
    ...
    pharosd = {
      ...
      image = "ghcr.io/inspr-at/pharos/pharosd:0.1.77@sha256:e3ed516ce719d18321b43a0d2470b21dd4b7239e56ca5fa2e8df0a7c24f069ba";
