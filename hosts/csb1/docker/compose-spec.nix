...
in
{
  ...
  services = {
    ...
    pharosd = {
      ...
      image = "ghcr.io/inspr-at/pharos/pharosd:260911012118.0.0@sha256:0239f2c7c2204079cbac004fb7faa31702421923b8ebb9d66f0998b184854995";
    ...
    inspr-www = {
      ...
      labels = [
        ...
        "traefik.http.routers.inspr-aithema.rule=Host(`aithema.inspr.at`)"
        "traefik.http.routers.inspr-aithema.tls=true"
        "traefik.http.routers.inspr-aithema.tls.certresolver=default"
        "traefik.http.routers.inspr-aithema.middlewares=cloudflarewarp@file"
        "traefik.http.routers.inspr-aithema.service=inspr-sites"
        ...
        "traefik.http.routers.inspr-sites-http.rule=Host(`inspr.at`) || Host(`www.inspr.at`) || Host(`aithema.inspr.at`) || Host(`paimos.inspr.at`) || Host(`pharos.inspr.at`) || Host(`janus.inspr.at`) || Host(`v1.inspr.at`)"
