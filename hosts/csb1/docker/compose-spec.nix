...
in
{
  ...
  services = {
    ...
    # AEON-13: PAIMOS AEON app (https://aeon.barta.cm), release v260926185841.0.0.
    ...
    aeon = {
      image = "ghcr.io/inspr-at/aeon:260926185841.0.0@sha256:2764b9dda34c3752186e71464b90f364c6dd56e13b877ec16e0e67b002467ec9"; # Live indicator styles (AEON-184), /agents missions (AEON-192), glass graph (AEON-194), ticket graph API (AEON-196)
      container_name = "aeon";
      restart = "unless-stopped";
      environment = [
        "AEON_ENV=prod"
      ...
      labels = [
        ...
        "traefik.http.routers.aeon.tls=true"
        "traefik.http.routers.aeon.tls.certresolver=default"
        "traefik.http.routers.aeon.middlewares=cloudflarewarp@file"
        "traefik.http.services.aeon.loadbalancer.server.port=8080"
      ];
    };
    # AEON-12: PAIMOS AEON database (Postgres 18 + pgvector). Superuser and app
    # passwords are host-generated by aeon-secrets.service (never in git or agenix);
    # the app role is created by aeon/initdb without superuser or BYPASSRLS.
    aeon-db = {
      image = "pgvector/pgvector:0.8.6-pg18@sha256:2ba9ca5f2e7daa0f0e7723cba1ee9167bab54efd3640516a44ac1a928dd67e7a";
      container_name = "aeon-db";
      restart = "unless-stopped";
      environment = [
      ...
      volumes = [
        ...
        "/var/lib/aeon-secrets/db-superuser-password:/run/secrets/aeon-db-superuser-password:ro"
        "/var/lib/aeon-secrets/db-password:/run/secrets/aeon-db-password:ro"
    ...
    janus-engine-staged = {
      ...
      image = "ghcr.io/inspr-at/janus/janus-engine:rust-engine-v0.1.44@sha256:bee5a2449d9d87516f57d0e2910e99d97915e12b6beb3af0a38bc6310e024487";
    ...
    pharosd = {
      ...
      image = "ghcr.io/inspr-at/pharos/pharosd:260925163010.0.0@sha256:811abc02316aa914fc4e6b3649dff0b4d9b9953819f7e4edab4aab14bf1045c1";
  ...
  networks = {
    internal = null;
    # AEON-12: database-only network; the app joins it plus traefik.
    aeon = {
      internal = true;
    };
    traefik = null;
