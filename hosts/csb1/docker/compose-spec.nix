...
# at runtime via agenix-decrypted bind. No plaintext secrets in this file.
{
  ...
  services = {
    ...
    janus = {
      ...
      image = "ghcr.io/inspr-at/janus/janus-envelope:go-envelope-v1.178@sha256:7e76eb5ec9a2b1f5bdcb5228cbd2b0a0c26c7e78bb5f2cde3f4c5361d5348167";
    ...
    pharosd = {
      ...
      image = "ghcr.io/inspr-at/pharos/pharosd:0.1.80@sha256:89b6f238ea7e53a26cca3061b38639d70947a2f1d3b989e4b6488c06cfed1772";
