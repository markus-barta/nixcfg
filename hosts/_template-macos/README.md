...
`modules/config/karabiner.json` config automatically, and the app itself comes
with the Brewfile baseline (`just bundle`). Grant Input Monitoring permissions
in System Settings on hosts that should use the keyboard remaps.
