...
# Configuration - csb0
SERVER_ID="${NETCUP_SERVER_ID:-607878}"
SERVER_NAME="${NETCUP_SERVER_NAME:-v2202401214994252795}"
...
if [ ! -f "$TOKEN_FILE" ]; then
  ...
  echo
  echo "Copy token from csb1:"
  echo "  cp hosts/csb1/secrets/netcup-api-refresh-token.txt $TOKEN_FILE"
  exit 0
fi
