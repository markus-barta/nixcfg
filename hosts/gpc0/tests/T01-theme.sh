...
print_header "T01 - Theme Module Tests (gpc0 / purple)"
...
check_file_contains "$STARSHIP_CONFIG" "gpc0" "Starship config mentions hostname 'gpc0'"
check_file_contains "$STARSHIP_CONFIG" "Purple" "Starship config mentions 'Purple' theme"
check_file_contains "$STARSHIP_CONFIG" "theme-hm.nix" "Starship config auto-generated by theme-hm.nix"
check_file_contains "$STARSHIP_CONFIG" "purple" "Starship config uses purple palette"
...
# ────────────────────────────────────────────────────────────────────────────────
# T01.3 - Starship Purple Palette Colors
# ────────────────────────────────────────────────────────────────────────────────

print_test "T01.3 - Starship Colors (purple palette)"

# These are the purple gradient colors from theme-palettes.nix
check_file_contains "$STARSHIP_CONFIG" "#d0b8e8" "Lightest gradient color (lavender) present"
check_file_contains "$STARSHIP_CONFIG" "#9868d0" "Primary gradient color (vibrant purple) present"
check_file_contains "$STARSHIP_CONFIG" "#7850a8" "Secondary gradient color present"
...
check_file_contains "$ZELLIJ_CONFIG" "gpc0" "Zellij config mentions hostname 'gpc0'"
check_file_contains "$ZELLIJ_CONFIG" "Purple" "Zellij config mentions 'Purple' theme"
...
check_file_contains "$ZELLIJ_CONFIG" 'theme "gpc0"' "Zellij uses hostname as theme name"
check_file_contains "$ZELLIJ_CONFIG" "gpc0 {" "Zellij theme block defined for gpc0"
