{
  ...
  inputs = {
    ...
    joedesk = {
      url = "github:markus-barta/joedesk/573d8c50b61b3c61aa67343d92a193d876774a92";
      flake = false;
    };
    hostdash = {
    ...
    paimos = {
      url = "github:inspr-at/paimos/v260915004615.0.0";
      flake = false;
    };
    ...
    # previous v0.11.0 / 477ae3f2169ca1aefbaf16e03eea1a2ed6c1cc8b pair.
    inspr-modules.url = "github:inspr-at/inspr-modules/acbb6194b60b496be2a5928cd616443e9d8d7baa";
