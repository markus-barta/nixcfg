...
in
{
  ...
  home-manager.users = lib.genAttrs hokage.usersWithRoot (_userName: {
    ...
    programs = {
      # Starship: With hokage.catppuccin.enable = false, this workaround may not be needed
      # Testing removal - see .pm/backlog/2025-12-01-catppuccin-follows-cleanup.md
      # starship.enable = lib.mkForce false;  # REMOVED - testing if still needed
