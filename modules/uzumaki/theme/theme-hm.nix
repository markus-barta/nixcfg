...
let
  ...
  # ════════════════════════════════════════════════════════════════════════════
  # ZELLIJ CONFIG GENERATOR (Template-based for naming consistency)
  # ════════════════════════════════════════════════════════════════════════════

  zellijTemplate = builtins.readFile ./zellij-themes/tokyonight-uzumaki.kdl;
  ...
  mkZellijConfig =
    ...
    builtins.replaceStrings
      ...
      [
        ...
        z.bg
        z.fg
        (z.keybindFg or themePalettes.statusColors.root.bg)
        z.highlight
        p.gradient.primary
        themePalettes.statusColors.sudo.fg
        p.gradient.secondary
        themePalettes.statusColors.error.bg
        p.gradient.lightest
        z.black
        z.white
      ]
