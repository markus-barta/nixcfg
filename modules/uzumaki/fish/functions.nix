...
#
{
  ...
  helpfish = {
    ...
    body = ''
      ...
      printf "  $color_alias%-12s$color_reset →  %-24s  $color_dim# %-24s$color_reset\n" "gitc" "git commit" "Commit changes"
      ...
      printf "  $color_abbr%-12s$color_reset →  %-18s  $color_dim# %-28s$color_reset\n" "cl" "clear" "Clear screen"
      ...
      printf "  $color_abbr%-12s$color_reset →  %s\n" "hsb0" "Home server 0 (192.168.1.99)"
