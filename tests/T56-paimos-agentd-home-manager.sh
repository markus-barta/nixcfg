...
printf 'T56 passed: mbp2607 pins Paimos 260911172741.0.0 with authenticated private agentd reporting, lifecycle control, owner-only Codex accounts, and prepared Cursor argv\n'
